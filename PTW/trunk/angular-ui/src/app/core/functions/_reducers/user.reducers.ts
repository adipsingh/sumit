...
export function functionReducer(state = initialUsersState, action: UserActions): UsersState {
    switch  (action.type) {
...
export const getUserState = createFeatureSelector<UsersState>('function');
