...
export interface CustomersState extends EntityState<CertificateQAModel> {
    listLoading: boolean;
...
export const adapter: EntityAdapter<CertificateQAModel> = createEntityAdapter<CertificateQAModel>();
...
export const getCustomerState = createFeatureSelector<CertificateQAModel>('company');
