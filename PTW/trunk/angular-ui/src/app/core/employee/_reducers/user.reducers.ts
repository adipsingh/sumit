...
export function employeeReducer(state = initialUsersState, action: UserActions): UsersState {
    switch  (action.type) {
...
export const getUserState = createFeatureSelector<UsersState>('employes');
