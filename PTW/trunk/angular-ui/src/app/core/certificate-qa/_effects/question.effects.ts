...
import {
    ...
    QuestionCreated} from '../_actions/question.actions';
import { of } from 'rxjs';
...
export class QuestionEffects {
    ...
    .pipe(
        ...
        mergeMap(( { payload } ) => {
            ...
            const requestToServer = this.questionsService.findQuestions(payload.page);
    ...
    deleteQuestion$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                    ...
                    return this.questionsService.deleteQuestion(payload.id);
                }
            ),
            map(() => {
    ...
    deleteQuestions$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                    this.store.dispatch(this.showLoadingDistpatcher);
                    return this.questionsService.deleteQuestions(payload.ids);
                }
            ),
            map(() => {
                return this.hideActionLoadingDistpatcher;
    ...
    updateQuestion$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                this.store.dispatch(this.showLoadingDistpatcher);
                return this.questionsService.updateQuestion(payload.question);
            }),
            map(() => {
                return this.hideActionLoadingDistpatcher;
            })
   ...
   /* @Effect()
    ...
    createQuestion$ = this.actions$
        .pipe(
            ...
            mergeMap(( { payload } ) => {
                this.store.dispatch(this.showLoadingDistpatcher);
                return this.questionsService.createQuestion(payload.question).pipe(
                    tap(res => {
