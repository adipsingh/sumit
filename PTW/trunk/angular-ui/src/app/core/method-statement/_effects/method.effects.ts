...
// Services
import { MethodService } from '../_services/';
// State
...
export class CategoryEffects {
    ...
    loadCategorysPage$ = this.actions$.pipe(
        ...
        mergeMap(( { payload } ) => {
            ...
            const requestToServer = this.customersService.findMethod(payload.page);
    ...
    constructor(private actions$: Actions, private customersService: MethodService, private store: Store<AppState>) { }
}
