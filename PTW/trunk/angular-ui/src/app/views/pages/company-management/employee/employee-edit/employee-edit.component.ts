...
export class EmployeeEditComponent implements OnInit, OnDestroy {
	...
	initUser() {
		...
		if (!this.user.id) {
			...
			this.subheaderService.setBreadcrumbs([
				{ title: 'Employee Management', page: `employee-management` },
				{ title: 'Employee',  page: `employee-management/employee` },
				{ title: 'Create employee', page: `employee-management/employee/add` }
			]);
			return;
		}
		...
		this.subheaderService.setBreadcrumbs([
			{ title: 'Employee Management', page: `employee-management` },
			{ title: 'Employee',  page: `employee-management/employee` },
			{ title: 'Edit Employee', page: `employee-management/employee/edit`, queryParams: { id: this.user.id } }
		]);
	}
	 ...
	 */
	goBackWithId() {
		const url = `${this.layoutConfigService.getCurrentMainRoute()}/employee-management/employee`;
	...
	refreshUser(isNew: boolean = false, id = 0) {
		...
		url = `${this.layoutConfigService.getCurrentMainRoute()}/employee-management/employee/edit/${id}`;
		this.router.navigateByUrl(url, { relativeTo: this.activatedRoute });
	}
