...
@Component({
	selector: 'kt-precaution-qa',
	templateUrl: './precaution-qa.component.html',
})
export class PrecautionQaComponent implements OnInit, OnDestroy {
	// Public properties
	user: User;
	 ...
	 */
	getComponentTitle() {
		let result = 'Create Precaution Questions';
		if (!this.user || !this.user.id) {
			return result;
		}

		result = `Edit Precaution Questions - ${this.user.fullname}`;
		return result;
	}
