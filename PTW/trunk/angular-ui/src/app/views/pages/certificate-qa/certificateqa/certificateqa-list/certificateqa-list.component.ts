...
// Services and Models
import { CustomerModel, CustomersDataSource, CustomersPageRequested, OneCustomerDeleted, ManyCustomersDeleted, CustomersStatusUpdated } from '../../../../../core/certificateqa';
// Components
import { CustomerEditDialogComponent } from '../certificateqa-edit/certificateqa-edit.dialog.component';
...
@Component({
	...
	selector: 'kt-certificateqa-list',
	templateUrl: './certificateqa-list.component.html',
...
export class CustomersListComponent implements OnInit, OnDestroy {
	 ...
	 * @param status: number
	 */
	getItemCssClassByStatus(excavation: boolean ): string {
		switch (excavation) {
			case true:
				return 'success';
			case false:
	 ...
	 * @param status: number
	 */
	getItemStatusString(excavation: boolean): string {
		switch (excavation) {
			case true:
				return 'true';
			case false:
	 ...
	 * @param status: number
	 */
	getItemCssClassByType(excavation:boolean): string {
		switch (excavation) {
			case true:
				return 'primary';
			case false:
	 ...
	 * @param status: number
	 */
	getItemTypeString(excavation: boolean): string {
		switch (excavation) {
			case true:
				return 'true';
			case false:
