...
// Services and Models
import { CustomerModel, CustomersDataSource, CustomersPageRequested, OneCustomerDeleted, ManyCustomersDeleted, CustomersStatusUpdated } from '../../../../core/workinhour';
// Components
...
@Component({
	...
	selector: 'kt-workinghour-list',
	templateUrl: './workinghour-list.component.html',
	changeDetection: ChangeDetectionStrategy.OnPush,

})
export class WorkinghourListComponent implements OnInit, OnDestroy {
	// Table fields
	dataSource: CustomersDataSource;
	displayedColumns = ['select', 'id', 'start', 'finish', 'actions'];
	...
	editCustomer(customer: CustomerModel) {
		...
		const dialogRef = this.dialog.open(WorkinghourEditDialogComponent, { data: { customer } });
		dialogRef.afterClosed().subscribe(res => {
			if (!res) {
				return;
			}
