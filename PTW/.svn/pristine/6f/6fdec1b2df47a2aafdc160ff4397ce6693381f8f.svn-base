...
export class CustomerOnServerCreated implements Action {
    ...
    constructor(public payload: { customer: CertificateQAModel }) { }
}
...
export class CustomerUpdated implements Action {
    ...
    constructor(public payload: {
        partialCustomer: Update<CertificateQAModel>, // For State update
        customer: CertificateQAModel // For Server update (through service)
    }) { }
}
...
export class CustomersPageLoaded implements Action {
    ...
    constructor(public payload: { customers: CertificateQAModel[], totalCount: number, page: QueryParamsModel }) { }
}
