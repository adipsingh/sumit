...
// Services and Models
import { CertificateQAModel, CustomersDataSource, CustomersPageRequested, OneCustomerDeleted, ManyCustomersDeleted, CustomersStatusUpdated } from '../../../../../core/e-commerce';
// Components
import { CustomerEditDialogComponent } from '../company-edit/company-edit.dialog.component';
...
export class CustomersListComponent implements OnInit, OnDestroy {
	...
	displayedColumns = ['select', 'id', 'name', 'catagory', 'code', 'actions'];
	...
	filterType: string = '';
	// Selection
	selection = new SelectionModel<CertificateQAModel>(true, []);
	customersResult: CertificateQAModel[] = [];
	// Subscriptions
	 ...
	 */
	deleteCustomer(_item: CertificateQAModel) {
	 ...
	 */
	addCustomer() {
		const newCustomer = new CertificateQAModel();
	 ...
	 * @param customer: CertificateQAModel
	 */
	editCustomer(customer: CertificateQAModel) {
