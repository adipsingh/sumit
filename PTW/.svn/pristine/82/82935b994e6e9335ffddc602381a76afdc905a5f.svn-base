...
export class CustomerOnServerCreated implements Action {
    ...
    constructor(public payload: { customer: PrecautionQAModel }) { }
}
...
export class CustomerUpdated implements Action {
    ...
    constructor(public payload: {
        partialCustomer: Update<PrecautionQAModel>, // For State update
        customer: PrecautionQAModel // For Server update (through service)
    }) { }
}
...
export class CustomersPageLoaded implements Action {
    ...
    constructor(public payload: { customers: PrecautionQAModel[], totalCount: number, page: QueryParamsModel }) { }
}
